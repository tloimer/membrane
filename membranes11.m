% MEMBRANES11 Berechne tau und beta mittels linearer Regression an N2-Daten.
% Weiters werden Werte zur Fehlerabschätzung berechnet und in membranes11.tsv
% geschrieben.
...
disp('Regression, roh (1/tau, beta/tau), 95% Konfidenzintervall');
...
%  regress(perm./mem.kappa,[kn_nu xialt]);
