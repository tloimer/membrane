...
x3 = flowstruct.f.x(a3,flowstruct.s.v(T0s,flowstruct.s.ps(T0s)), ...
  1/flowstruct.s.rho(T0s));
...
title(sprintf(...
  ...
  flowstruct.info.kap/flowstruct.info.kapc, deltap/1e5, T0-Te, m, ...
  flowstruct.sol.de/L, tmpsol, flowstruct.sol.p0-p0,T0s-T0,flowstruct.sol.q3));
ylabel('T [K]');
xlim([xl 1]);
