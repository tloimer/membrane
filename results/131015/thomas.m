function thomas()
%FIGURES     Create figures for presumably J. Membr. Sci. 2014.
...
% Thomas et al. (2001)
pt5 = membrane(3e-6,0.6,36,'tube',4,8.1,1.5e-3);
pt4 = membrane(1e-6,0.6,36,'tube',3.6,8.1,25e-6);
pt3 = membrane(200e-9,0.6,36,'tube',3.1,8.1,25e-6);
pt2 = membrane(60e-9,0.8,36,'tube',2,8.1,25e-6);
%pt1 = membrane(6e-9,0.8,36,'tube',1.1,8.1,3e-6);


psmems = {{pt2 pt3 pt4 pt5}}; pms = mstackstruct(0,psmems,f); pmsorig = pms;
prmems = {{pt5 pt4 pt3 pt2}}; pmr = mstackstruct(0,prmems,f); pmrorig = pmr;
